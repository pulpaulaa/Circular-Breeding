...
let jugador = {
  //este objeto se reinicia cada vez que se cambia de HTML
  nombre: "",
  implementos: [],
  capacidad: 0,
  avatar: "",
...
if (document.body.id == "p0") {
  ...
  sessionStorage.setItem(
    "jugador_involucramiento",
    "perkin,0,karen,0,ñuñoino,0"
  );
  sessionStorage.setItem("jugador_prioridad", "humano,0,perro,0,vínculo,0");
  sessionStorage.setItem(
    "jugador_responsabilidad",
    "individualista,0,cuadrado,0,vegano,0"
  );
...
function fb_pje1() {
  ...
  if (btn1 !== null) {
    //si existe el btn
    if (feedback1 !== null && puntaje1 == null) {
      //existe feedback pero no puntaje
      ...
      //p12_1:
      if (
        document.body.id == "p12_1" &&
        lista_implementos.includes("Agua") == false
      ) {
        feedback1_1.style.display = "flex";
      } else if (document.body.id == "p12_1") {
        //trigger feedback1 -> SÍ TRAJO EL IMPLEMENTO
        feedback1.style.display = "flex";
      }
      //p12_2:
      if (
        document.body.id == "p12_2" &&
        lista_implementos.includes("Agua") == false
      ) {
        feedback1_1.style.display = "flex";
      } else if (document.body.id == "p12_2") {
        //trigger feedback1 -> SÍ TRAJO EL IMPLEMENTO
        feedback1.style.display = "flex";
      }
      //p11_2:
      if (
        document.body.id == "p11_2" &&
        lista_implementos.includes("Celular") == false
      ) {
        feedback1_1.style.display = "flex";
    ...
    } else if (feedback1 == null && puntaje1 !== null) {
      //existe puntaje pero no feedback
      //puntaje:
...
function fb_pje2() {
  ...
  if (btn2 !== null) {
    //si existe el btn
    if (feedback2 !== null && puntaje2 == null) {
      //existe feedback pero no puntaje
      //pasar string implementos de sessionStorage a array para buscar
      string_implementos = sessionStorage.getItem("jugador_implementos");
      lista_implementos = string_implementos.split(","); //pasar a array
      ...
      //p5_1:
      if (
        document.body.id == "p5_1" &&
        lista_implementos.includes("Premios") == false
      ) {
        feedback2_1.style.display = "flex";
      } else if (document.body.id == "p5_1") {
        //trigger feedback2 -> SÍ TRAJO EL IMPLEMENTO
        feedback2.style.display = "flex";
      }
      //p5_2:
      if (
        document.body.id == "p5_2" &&
        lista_implementos.includes("Premios") == false
      ) {
        feedback2_1.style.display = "flex";
      } else if (document.body.id == "p5_2") {
      ...
      if (
        document.body.id == "p8" &&
        lista_implementos.includes("Bolsas") == false
      ) {
        feedback2_1.style.display = "flex";
      } else if (document.body.id == "p8") {
        feedback2.style.display = "flex";
    ...
    } else if (feedback2 == null && puntaje2 !== null) {
      //existe puntaje pero no feedback
      //puntaje:
      if (document.body.id == "p4") {
        p4_puntaje(2);
...
function fb_pje3() {
  ...
  if (btn3 !== null) {
    //si existe el btn
    if (feedback3 !== null && puntaje3 == null) {
      //existe feedback pero no puntaje
      //aparece feedback:
      feedback3.style.display = "flex";
    } else if (feedback3 == null && puntaje3 !== null) {
      //existe puntaje pero no feedback
      //puntaje:
...
function fb_pje4() {
  ...
  if (btn4 !== null) {
    //si existe el btn
    if (feedback4 !== null && puntaje4 == null) {
      //existe feedback pero no puntaje
      //aparece feedback:
...
if (document.body.id == "p3") {
  ...
  document.getElementById("text-p3").innerHTML =
  ...
  function agregar_impl(implemento, num_id) {
    ...
    if (counter <= capacidad) {
      ...
      if (jugador.implementos.includes(implemento)) {
        //si ya fue elegido
  ...
  function storage_p3() {
    ...
    //lista anterior:
    let string_implementos_antes = sessionStorage.getItem(
      "jugador_implementos"
    ); //recibir string anterior
    ...
    const lista_implementos = lista_implementos_antes.concat(
      lista_implementos_agregar
    );
    let string_implementos = lista_implementos.toString(); //string
    ...
    lista_prioridad[1] = String(
      Number(lista_prioridad[1]) + jugador.pri_humano
    );
    lista_prioridad[3] = String(Number(lista_prioridad[3]) + jugador.pri_perro);
    lista_prioridad[5] = String(
      Number(lista_prioridad[5]) + jugador.pri_vínculo
    );
...
function p4_puntaje(camino) {
  ...
  lista_sociabilidad[1] = String(
    Number(lista_sociabilidad[1]) + jugador.soc_popular
  );
  lista_sociabilidad[3] = String(
    Number(lista_sociabilidad[3]) + jugador.soc_ermitaño
  );
...
function p5_1_puntaje(camino) {
  ...
  //rescatar del storage y pasar a array
  let string_involucramiento = sessionStorage.getItem(
    "jugador_involucramiento"
  );
  let string_responsabilidad = sessionStorage.getItem(
    "jugador_responsabilidad"
  );
  let lista_involucramiento = string_involucramiento.split(",");
  let lista_responsabilidad = string_responsabilidad.split(",");
  //actualizar valores y pasar a string
  lista_involucramiento[1] = String(
    Number(lista_involucramiento[1]) + jugador.inv_perkin
  );
  lista_involucramiento[3] = String(
    Number(lista_involucramiento[3]) + jugador.inv_karen
  );
  lista_involucramiento[5] = String(
    Number(lista_involucramiento[5]) + jugador.inv_ñuñoino
  );
  string_involucramiento = lista_involucramiento.toString();
  lista_responsabilidad[1] = String(
    Number(lista_responsabilidad[1]) + jugador.res_individualista
  );
  lista_responsabilidad[3] = String(
    Number(lista_responsabilidad[3]) + jugador.res_cuadrado
  );
  lista_responsabilidad[5] = String(
    Number(lista_responsabilidad[5]) + jugador.res_vegano
  );
...
function calcular_avatar() {
  ...
  if (perkin > karen && perkin > ñuñoino) {
    //gana perkin
    avatar_inv = "perkin";
  } else if (karen > perkin && karen > ñuñoino) {
    // gana karen
    avatar_inv = "karen";
  } else if (ñuñoino > karen && ñuñoino > perkin) {
    // gana ñuñoino
    avatar_inv = "ñuñoíno";
  } else {
    //empate
    if (karen == perkin && karen == ñuñoino) {
      //tri empate
    ...
    } else if (karen == ñuñoino && karen !== perkin) {
      //empate karen ñuñoino
    ...
    } else if (perkin == ñuñoino && karen !== perkin) {
      //empate perkin ñuñoino
      const desempate_inv = random_num(1, 2);
      if (desempate_inv == 1) {
        avatar_inv = "perkin";
      } else {
  ...
  //  prioridad:
  if (humano > perro && humano > vínculo) {
    //gana humano
    avatar_pri = "humano";
  } else if (perro > humano && perro > vínculo) {
    // gana perro
    avatar_pri = "perro";
  } else if (vínculo > perro && vínculo > humano) {
    // gana vínculo
    avatar_pri = "vínculo";
  } else {
    //empate
    ...
    } else if (perro == vínculo && perro !== humano) {
      //empate perro vinculo
      const desempate_inv = random_num(1, 2);
      if (desempate_inv == 1) {
        avatar_pri = "perro";
      } else {
    ...
    } else if (humano == vínculo && perro !== humano) {
      //empate humano vinculo
      const desempate_inv = random_num(1, 2);
      if (desempate_inv == 1) {
        avatar_pri = "humano";
      } else {
  ...
  //  responsabilidad:
  if (individualista > cuadrado && individualista > vegano) {
    //gana individualista
    avatar_res = "individualista";
  } else if (cuadrado > individualista && cuadrado > vegano) {
    // gana cuadrado
    avatar_res = "cuadrado";
  } else if (vegano > cuadrado && vegano > individualista) {
    // gana vegano
    avatar_res = "vegano";
  } else {
    //empate
    if (individualista == cuadrado && individualista == vegano) {
    ...
    } else if (cuadrado == vegano && cuadrado !== individualista) {
      //empate cuadrado vegano
      const desempate_inv = random_num(1, 2);
      if (desempate_inv == 1) {
        avatar_res = "cuadrado";
      } else {
      ...
      //empate cuadrado individualista
      const desempate_inv = random_num(1, 2);
      if (desempate_inv == 1) {
        avatar_res = "cuadrado";
      } else {
    ...
    } else if (individualista == vegano && cuadrado !== individualista) {
      //empate individualista vegano
      const desempate_inv = random_num(1, 2);
      if (desempate_inv == 1) {
        avatar_res = "individualista";
      } else {
  ...
  let avatar =
    avatar_inv + "," + avatar_pri + "," + avatar_res + "," + avatar_soc;
  ...
  function random_num(min, max) {
    //habria que darle un valor a cada uno
...
function cargar_avatar() {
  ...
  string_avatar =
    String(lista_avatar[0]) +
    " " +
    String(lista_avatar[1]) +
    " " +
    String(lista_avatar[2]) +
    " " +
    String(lista_avatar[3]);
  //setear innerHTML que foto es
  //
  //console.log(lista_avatar);
  //debugger;
  if (lista_avatar[0] == "ñuñoíno") {
    //N___
    if (lista_avatar[1] == "humano") {
      ...
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          ...
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NYP0.png";
        } else {
          //NYE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NYE0.png";
        }
        ...
        if (lista_avatar[3] == "popular") {
          //NCP0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NCP0.png";
        } else {
          //NCE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NCE0.png";
        }
        ...
        if (lista_avatar[3] == "popular") {
          //NVP0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NVP0.png";
        } else {
          //NVE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NVE0.png";
        }
      }
      ...
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          //NYP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NYP1.png";
        } else {
          //NYE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NYE1.png";
        }
      } else if (lista_avatar[2] == "cuadrado") {
        //NC_1
        if (lista_avatar[3] == "popular") {
          //NCP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NCP1.png";
        } else {
          //NCE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NCE1.png";
        }
      } else if (lista_avatar[2] == "vegano") {
        //NV_1
        if (lista_avatar[3] == "popular") {
          //NVP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NVP1.png";
        } else {
          //NVE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NVE1.png";
        }
      }
      ...
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          //NYP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NYP2.png";
        } else {
          //NYE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NYE2.png";
        }
      } else if (lista_avatar[2] == "cuadrado") {
        //NC_2
        if (lista_avatar[3] == "popular") {
          //NCP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NCP2.png";
        } else {
          //NCE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NCE2.png";
        }
      } else if (lista_avatar[2] == "vegano") {
        //NV_2
        if (lista_avatar[3] == "popular") {
          //NVP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NVP2.png";
        } else {
          //NVE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/NVE2.png";
        }
      }
    }
  } else if (lista_avatar[0] == "karen") {
    //N___
    if (lista_avatar[1] == "humano") {
      //K__0
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          //KYP0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KYP0.png";
        } else {
          //KYE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KYE0.png";
        }
      } else if (lista_avatar[2] == "cuadrado") {
        //KC_0
        if (lista_avatar[3] == "popular") {
          //KCP0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KCP0.png";
        } else {
          //KCE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KCE0.png";
        }
      } else if (lista_avatar[2] == "vegano") {
        //KV_0
        if (lista_avatar[3] == "popular") {
          //KVP0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KVP0.png";
        } else {
          //KVE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KVE0.png";
        }
      }
    } else if (lista_avatar[1] == "vínculo") {
      //K__1
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          //KYP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KYP1.png";
        } else {
          //KYE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KYE1.png";
        }
      } else if (lista_avatar[2] == "cuadrado") {
        //KC_1
        if (lista_avatar[3] == "popular") {
          //KCP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KCP1.png";
        } else {
          //KCE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KCE1.png";
        }
      } else if (lista_avatar[2] == "vegano") {
        //KV_1
        if (lista_avatar[3] == "popular") {
          //KVP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KVP1.png";
        } else {
          //KVE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KVE1.png";
        }
      }
    } else if (lista_avatar[1] == "perro") {
      //K__2
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          //KYP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KYP2.png";
        } else {
          //KYE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KYE2.png";
        }
      } else if (lista_avatar[2] == "cuadrado") {
        //KC_2
        if (lista_avatar[3] == "popular") {
          //KCP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KCP2.png";
        } else {
          //KCE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KCE2.png";
        }
      } else if (lista_avatar[2] == "vegano") {
        //KV_2
        if (lista_avatar[3] == "popular") {
          //KVP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KVP2.png";
        } else {
          //KVE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/KVE2.png";
        }
      }
    }
    ...
    if (lista_avatar[1] == "humano") {
      ...
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          //MYP0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MYP0.png";
        } else {
          //MYE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MYE0.png";
        }
      } else if (lista_avatar[2] == "cuadrado") {
        //MC_0
        if (lista_avatar[3] == "popular") {
          //MCP0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MCP0.png";
        } else {
          //MCE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MCE0.png";
        }
      } else if (lista_avatar[2] == "vegano") {
        //MV_0
        if (lista_avatar[3] == "popular") {
          //MVP0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MVP0.png";
        } else {
          //MVE0
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MVE0.png";
        }
      }
    } else if (lista_avatar[1] == "vínculo") {
      //M__1
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          //MYP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MYP1.png";
        } else {
          //MYE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MYE1.png";
        }
      } else if (lista_avatar[2] == "cuadrado") {
        //MC_1
        if (lista_avatar[3] == "popular") {
          //MCP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MCP1.png";
        } else {
          //MCE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MCE1.png";
        }
      } else if (lista_avatar[2] == "vegano") {
        //MV_1
        if (lista_avatar[3] == "popular") {
          //MVP1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MVP1.png";
        } else {
          //MVE1
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MVE1.png";
        }
      }
    } else if (lista_avatar[1] == "perro") {
      //M__2
      if (lista_avatar[2] == "individualista") {
        ...
        if (lista_avatar[3] == "popular") {
          //MYP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MYP2.png";
        } else {
          //MYE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MYE2.png";
        }
      } else if (lista_avatar[2] == "cuadrado") {
        //MC_2
        if (lista_avatar[3] == "popular") {
          //MCP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MCP2.png";
        } else {
          //MCE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MCE2.png";
        }
      } else if (lista_avatar[2] == "vegano") {
        //MV_2
        if (lista_avatar[3] == "popular") {
          //MVP2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MVP2.png";
        } else {
          //MVE2
          document.getElementById("avatar-img").src =
            "images/avatares_ai/MVE2.png";
        }
      }
    }
  }
  ...
  if (lista_avatar[0] == "karen") {
    ...
    document.getElementById("parr_inv").innerHTML =
      "Priorizas que tu perro se mantenga sano y salvo, lo alejas de todo potencial peligro.";
  } else if (lista_avatar[0] == "perkin") {
    document.getElementById("tit_inv").innerHTML = "Supermandoneao";
    document.getElementById("parr_inv").innerHTML =
      "Priorizas que tu perro tenga un paseo eficiente, lo guías para que utilicen el corto tiempo que tienen de manera óptima. En próximos paseos, podrías darte tiempo para disfrutar de este rato.";
  } else if (lista_avatar[0] == "ñuñoíno") {
    document.getElementById("tit_inv").innerHTML = "Ñuñoíno";
    document.getElementById("parr_inv").innerHTML =
      "Priorizas que tu perro explore y desarrolle sus habilidades, lo dejas libre para que sea quien es.";
  }
  //Significado Prioridad
  if (lista_avatar[1] == "humano") {
    document.getElementById("parr_pri").innerHTML =
      "Eres un pet lover que aprovecha el paseo para darse un tiempo para sí mismo. Este es un momento en el que tú, al igual que tu perro, tienen una instancia de distensión.";
  } else if (lista_avatar[1] == "perro") {
    document.getElementById("parr_pri").innerHTML =
      "Eres un pet lover que prioriza el bienestar de su mejor amigx. Para ti este es un momento dedicado cien por ciento a tu mascota.";
  } else if (lista_avatar[1] == "vínculo") {
    document.getElementById("parr_pri").innerHTML =
      "Eres un pet lover que se preocupa de fortalecer la conexión con su mascota. Para ustedes este es un momento esperado del día, les permite pasar tiempo juntxs y distraerse.";
  }
  //Significado Responsabilidad
  if (lista_avatar[2] == "individualista") {
    document.getElementById("tit_res").innerHTML = "Yoyito";
    document.getElementById("parr_res").innerHTML =
      "Al momento de pasear, el entorno queda en un segundo plano, esperamos que recuerdes al medioambiente y a los demás en tus próximos paseos.";
  } else if (lista_avatar[2] == "cuadrado") {
    document.getElementById("tit_res").innerHTML = "Cuadrado";
    document.getElementById("parr_res").innerHTML =
      "Al momento de pasear, te preocupas de que el ambiente sea agradable y justo para lxs demás, no solo para ti y tu perro.";
  } else if (lista_avatar[2] == "vegano") {
    document.getElementById("tit_res").innerHTML = "Vegano";
    document.getElementById("parr_res").innerHTML =
      "Al momento de pasear, el cuidado del entorno natural es esencial, tanto tú como tu perro se relacionan con el espacio de manera cuidadosa.";
  }
  //Significado Sociabilidad
  if (lista_avatar[3] == "popular") {
    document.getElementById("tit_soc").innerHTML = "Pana";
    document.getElementById("parr_soc").innerHTML =
      "Para ustedes, el paseo es una instancia para compartir, tanto con los otros perros como con los humanos.";
  } else if (lista_avatar[3] == "ermitaño") {
    document.getElementById("tit_soc").innerHTML = "Piola";
    document.getElementById("parr_soc").innerHTML =
      "Para ustedes, el paseo es una instancia privada, de la cual sólo forman parte tú y tu mascota.";
  }
}
